              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="text"
                    id="name"
                    className={`block w-full pl-10 pr-3 py-2.5 border rounded-lg bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-colors ${
                      errors.name
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    id="message"
                    rows={4}
                    className={`block w-full pl-10 pr-3 py-2.5 border rounded-lg bg-gray-50 dark:bg-slate-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-colors resize-none ${
                      errors.message
                        ? "border-red-300 dark:border-red-600"
                        : "border-gray-300 dark:border-slate-600"
                    }`}
