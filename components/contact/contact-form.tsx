          ...
          <div className="bg-white/5  backdrop-blur-sm border border-white/10 rounded-2xl p-5 shadow-xl h-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    type="text"
                    id="name"
                    className={`block w-full pl-10 pr-3 py-2.5 border rounded-lg bg-gray-50 dark:bg-slate-700/50 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-colors ${
                      errors.name
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <textarea
                    ...
                    id="message"
                    rows={4}
                    className={`block w-full pl-10 pr-3 py-2.5 border rounded-lg bg-gray-50 dark:bg-slate-700/50 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent transition-colors resize-none ${
                      errors.message
                        ? "border-red-300 dark:border-red-600"
                        : "border-gray-300 dark:border-slate-600"
                    }`}
              ...
              <button
                ...
                className="w-full bg-gray-50 dark:bg-slate-700/50 cursor-pointer hover:bg-gray-100 dark:hover:bg-slate-700 border border-white/15 disabled:bg-gray-700 text-gray-900 dark:text-white font-semibold py-3 px-6 rounded-lg transition-all duration-200 disabled:cursor-not-allowed flex items-center justify-center space-x-2"
              >
                {isSubmitting ? (
                  <>
